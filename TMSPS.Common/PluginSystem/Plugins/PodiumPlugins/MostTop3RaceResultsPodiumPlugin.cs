...
namespace TMSPS.Core.PluginSystem.Plugins.PodiumPlugins
{
    public class MostTop3RaceResultsPodiumPlugin : LocalRecordsPluginPlugin
    {
        ...
        private readonly string _linkPageID = "MostTop3RaceResultsPodiumPluginPanelID"; //Guid.NewGuid().ToString("N");
        ...
        {
            get { return "MostTop3RaceResultsPodiumPlugin"; }
        }

        public override string Description
        {
            get { return "Shows the players with the most race result within top 3."; }
        }

        public override string ShortName
        {
            get { return "MostTop3RaceResultsPodium"; }
        }
